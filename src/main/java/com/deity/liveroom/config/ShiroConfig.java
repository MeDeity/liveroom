...
//        webSecurityManager.setRealm(shiroRealmWrapper);
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(SecurityManager securityManager){
        ...
        filterChainDefinitionMap.put("/css/**","anon");//静态资源科匿名访问
        filterChainDefinitionMap.put("/image/**","anon");//静态资源科匿名访问
        filterChainDefinitionMap.put("/js/**","anon");//静态资源科匿名访问
        filterChainDefinitionMap.put("/json/**","anon");//静态资源科匿名访问
        filterChainDefinitionMap.put("/layui/**","anon");//静态资源科匿名访问
        filterChainDefinitionMap.put("/vonic/**","anon");//静态资源科匿名访问
